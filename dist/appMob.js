...
var TodoList = /** @class */ (function () {
    function TodoList() {
        this.newTitle = "enter message";
        this.todos = [];
    }
    Object.defineProperty(TodoList.prototype, "unfinishedTodoCount", {
        get: function () {
            return this.todos.filter(function (todo) { return !todo.finished; }).length;
        },
        enumerable: true,
        configurable: true
    });
    TodoList.prototype.edit = function (value) {
        this.newTitle = value;
    };
    ...
    __decorate([
        mobx_1.observable
    ], TodoList.prototype, "newTitle", void 0);
    __decorate([
        mobx_1.observable
...
var TodoListView = /** @class */ (function (_super) {
    ...
    TodoListView.prototype.render = function () {
        ...
        return React.createElement("div", null,
            React.createElement("input", { type: "text", value: todoList.newTitle, onChange: function (e) { return todoList.edit(e.target.value); } }),
            React.createElement("input", { type: "button", onClick: function () { return todoList.add(); }, value: "add" }),
            React.createElement("br", null),
            React.createElement("ul", null, todoList.todos.map(function (todo) { return React.createElement(TodoView, { todo: todo, key: todo.id }); })),
            "Tasks left: ",
...
var TodoView = mobx_react_1.observer(function (_a) {
    ...
    return React.createElement("li", null,
        React.createElement("input", { type: "checkbox", checked: todo.finished, onChange: function () { }, onClick: function () { return todo.finished = !todo.finished; } }),
        todo.title);
});
function init(container) {
    var store = new TodoList();
    ReactDOM.render(React.createElement(TodoListView, { todoList: store }), document.getElementById(container));
    store.todos.push(new Todo("Get Coffee"), new Todo("Write simpler code"));
    store.todos[0].finished = true;
}
window.global = window.global || {};
window.global.init = window.global.init || {};
window.global.init["appmob"] = function (container) { return init(container); };
